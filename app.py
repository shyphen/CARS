...
GEMINI_API_KEY = "AIzaSyBct8u8MJZiqYK7XguBt084An7mAtym2TQ"  # Replace with your actual key
...
def chatbot_response(user_message):
    ...
    prompt = f"You are a helpful AI chatbot. Answer the following user message in a short and clean way:\n\nUser: {user_message}\nAI:"
